...
const Skills: React.FC = () => {
  ...
  const title = language === 'ar' ? 'المهارات | مطور ويب محترف' : 'Skills | Professional Web Developer';

  return (
    <>
      <Helmet>
        <title>{title}</title>
        <meta name="description" content={language === 'ar' ? 'مهاراتي التقنية والشخصية' : 'My technical and soft skills'} />
      </Helmet>
              ...
              {categories.map((category, catIndex) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xl font-bold">{category.title[language]}</h2>
                  </div>
