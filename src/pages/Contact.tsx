...
const Contact: React.FC = () => {
  ...
  const title = language === 'ar' ? 'تواصل معي | مطور ويب محترف' : 'Contact | Professional Web Developer';

  return (
    <>
      <Helmet>
        <title>{title}</title>
        <meta name="description" content={language === 'ar' ? 'تواصل معي لمناقشة مشروعك' : 'Get in touch to discuss your project'} />
      </Helmet>
